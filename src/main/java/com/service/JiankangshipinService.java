...
public interface JiankangshipinService extends IService<JiankangshipinEntity> {
    ...
    List<Map<String, Object>> selectValue(Map<String, Object> params,Wrapper<JiankangshipinEntity> wrapper);

    List<Map<String, Object>> selectTimeStatValue(Map<String, Object> params,Wrapper<JiankangshipinEntity> wrapper);

    List<Map<String, Object>> selectGroup(Map<String, Object> params,Wrapper<JiankangshipinEntity> wrapper);
