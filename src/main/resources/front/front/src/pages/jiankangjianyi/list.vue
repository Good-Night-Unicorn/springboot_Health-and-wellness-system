	...
	<div>
		...
		<div class="list-preview">
			<el-form :inline="true" :model="formSearch" class="list-form-pv">
				...
				<el-button class="list-add-btn" v-if="btnAuth('jiankangjianyi','新增')" type="primary" @click="add('/index/jiankangjianyiAdd')">
			...
			<div class="list">
				...
				<div class="list2 index-pv1">
					<div v-for="(item, index) in dataList" :key="index" class="list-item animation-box" @click.stop="toDetail(item)">
						<div class="item-info">
							<div class="name">健康评估:{{item.jiankangpinggu}}</div>
							<div class="name">饮食建议:{{item.yinshijianyi}}</div>
							<div class="name">建议时间:{{item.jianyishijian}}</div>
							<div class="time_item">
