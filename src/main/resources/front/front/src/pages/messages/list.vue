<template>
	<div :style='{"width":"1270px","padding":"20px","margin":"10px auto","position":"relative","background":"#fff"}'>
		<div class="section-title" :style='{"margin":"0 0 40px 0","color":"#896785","textAlign":"center","background":"url(http://codegen.caihongy.cn/20241122/cda88df66d42496fa403c0ed98bac06b.webp) no-repeat bottom","width":"101%","lineHeight":"160px","fontSize":"36px","fontWeight":"600px"}'>留言板</div>
