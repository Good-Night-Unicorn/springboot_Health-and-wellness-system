	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="input" v-else-if="ruleForm.zixunbianhao" label="咨询编号" prop="zixunbianhao" >
					<el-input v-model="ruleForm.zixunbianhao" placeholder="咨询编号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item class="input" v-if="type!='info'"  label="用药意见" prop="yongyaoyijian" >
					<el-input v-model="ruleForm.yongyaoyijian" placeholder="用药意见" clearable  :readonly="ro.yongyaoyijian"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="用药意见" prop="yongyaoyijian" >
			...
			<el-form-item v-else-if="ruleForm.yishengjianyi" label="医生建议" prop="yishengjianyi" >
				<span class="text">{{ruleForm.yishengjianyi}}</span>
			</el-form-item>
